...
if __name__ == "__main__":
    ...
    path_config = args.path_config # '/Users/laurenbolotin/Lauren/FSDS/fsds/scripts/eval_ingest/SI/SI_CFE_schema.yaml' 
    ...
    df_all_data = pd.read_csv(path_data,dtype={col_schema_df['gage_id'].loc[0] :str})
